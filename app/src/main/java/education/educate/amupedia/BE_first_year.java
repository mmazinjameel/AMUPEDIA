...
public class BE_first_year extends AppCompatActivity {
    ...
    private AdView befirstadview, befirstadview2, befirstadview3 , befirstadview4 , befirstadview5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        befirstadview2 = findViewById(R.id.befirst2_banner);
        AdRequest adRequest2 = new AdRequest.Builder().build();
        befirstadview2.loadAd(adRequest2);

        befirstadview3 = findViewById(R.id.befirst3_banner);
        AdRequest adRequest3 = new AdRequest.Builder().build();
        befirstadview3.loadAd(adRequest3);
        befirstadview4 = findViewById(R.id.befirst4_banner);
        AdRequest adRequest4 = new AdRequest.Builder().build();
        befirstadview4.loadAd(adRequest4);
        befirstadview5 = findViewById(R.id.befirst5_banner);
        AdRequest adRequest5 = new AdRequest.Builder().build();
        befirstadview5.loadAd(adRequest5);
